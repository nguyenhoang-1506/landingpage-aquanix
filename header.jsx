  ...
  return <>
    <header style={{ position: 'sticky', top: 0, zIndex: 20, background: 'var(--surface)', borderBottom: '1px solid var(--border)' }}>
      <div className="wrap hdr" style={{ height: 72, display: 'flex', alignItems: 'center', gap: 'var(--space-6)' }}>
        <a href="#top" onClick={go('top')} style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none', color: 'var(--ink)' }}><img src="./assets/logo/aquanix-mark.png" alt="Aquanix" style={{ height: 36 }} /><span style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.1 }}><span className="hdr-brand-text" style={{ fontWeight: 700, fontSize: 20, letterSpacing: '-0.01em', color: 'var(--brand-600)' }}>Aquanix</span><span className="hdr-slogan" style={{ fontSize: 11, fontWeight: 600, color: 'var(--accent-600)', letterSpacing: '.02em', whiteSpace: 'nowrap' }}>Nhật ký thủy sản điện tử</span></span></a>
